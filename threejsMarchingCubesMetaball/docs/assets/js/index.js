...
/* harmony import */ var _MarchingCubes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./MarchingCubes */ "./src/assets/js/_index/MarchingCubes.js");





var ENV = __webpack_require__(/*! ../_env */ "./src/assets/js/_env.js");

var g = window[ENV.projectName] = window[ENV.projectName] || {};
...
function () {
  function Main() {
    _babel_runtime_corejs2_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, Main);

    this.init();
  }

  _babel_runtime_corejs2_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(Main, [{
    key: "init",
    value: function init() {
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function init$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(this.initWebGL());
    ...
    value: function initWebGL() {
      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function initWebGL$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              return _context3.abrupt("return", new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a(function _callee(resolve, reject) {
                  ...
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      ...
                      case 4:
                        ...
                        _this.renderer.setPixelRatio(_this.devicePixelRatio); // scene


                        _this.scene = new THREE.Scene(); // camera

                        _this.camera = new THREE.PerspectiveCamera(45, 1, 1, 1000);
                        _this.camera.position.z = 100;

                        _this.camera.lookAt(0, 0, 0); // controls


                        _this.controls = new THREE.TrackballControls(_this.camera, _this.canvas);
                        _this.controls.rotateSpeed = 4; // marchingCubes

                        _this.marchingCubes = new _MarchingCubes__WEBPACK_IMPORTED_MODULE_4__["default"]();

                        _this.scene.add(_this.marchingCubes.mesh);
    ...
    value: function onResize() {
      var aspectRatio;
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function onResize$(_context4) {
        while (1) {
...
/***/ "./src/assets/js/_index/MarchingCubes.js":
/*!***********************************************!*\
  !*** ./src/assets/js/_index/MarchingCubes.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MarchingCubes; });
...
function () {
  function MarchingCubes() {
    ...
    this.material = new THREE.RawShaderMaterial({
      // wireframe: true,
      vertexShader: __webpack_require__(/*! ./_glsl/marchingCubes.vert */ "./src/assets/js/_index/_glsl/marchingCubes.vert"),
      fragmentShader: __webpack_require__(/*! ./_glsl/marchingCubes.frag */ "./src/assets/js/_index/_glsl/marchingCubes.frag"),
      side: THREE.DoubleSide,
      defines: {
        NUM_SPHERES: this.numSpheres
      },
      uniforms: {
        triTableTexture: {
          type: 't',
          value: this.triTableTexture
        },
        sphereColor: {
          type: 'c',
          value: new THREE.Color(this.sphereColor[0] / 255, this.sphereColor[1] / 255, this.sphereColor[2] / 255)
        },
        time: {
          type: '1f',
          value: 0
  ...
  _babel_runtime_corejs2_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(MarchingCubes, [{
    key: "updateMargingCubesSpace",
    value: function updateMargingCubesSpace() {
      var marchingSpace = new THREE.Vector3(this.margingSpaceSize, this.margingSpaceSize, this.margingSpaceSize);
      var numCells = new THREE.Vector3(this.numMarchingSegments, this.numMarchingSegments, this.numMarchingSegments);
      var cellSize = new THREE.Vector3(marchingSpace.x / numCells.x, marchingSpace.y / numCells.y, marchingSpace.z / numCells.z);
      var numVertices = numCells.x * numCells.y * numCells.z * 15; // 1セルの頂点の数は15個
    ...
    key: "updateNumSpheres",
    value: function updateNumSpheres() {
      var randomValues = [];

      for (var i = 0; i < this.numSpheres - 1; i++) {
        randomValues.push(new THREE.Vector4(Math.random(), Math.random(), Math.random(), Math.random()));
      }

      var positions = new THREE.Vector4(.1, .1, .1, 0);
    ...
    value: function initDatGUI() {
      ...
      this.gui.add(this, 'effectValue', 0, 1, this.effectValue).step(0.01).onChange(function (value) {
        _this.material.uniforms.effectValue.value = value;
      });
      this.gui.add(this, 'smoothUnionValue', 0, 30, this.smoothUnionValue).step(0.01).onChange(function (value) {
        _this.material.uniforms.smoothUnionValue.value = value;
      });
      this.gui.add(this, 'numMarchingSegments', 4, 64, this.numMarchingSegments).step(2).onFinishChange(function (value) {
        _this.updateMargingCubesSpace();
      });
      this.gui.add(this, 'numSpheres', 1, 3, this.numSpheres).step(1).onFinishChange(function (value) {
        _this.updateNumSpheres();
      });
      this.isWireframe = this.material.wireframe;
      this.gui.add(this, 'isWireframe').onChange(function (value) {
        _this.material.wireframe = value;
        _this.material.needsUpdate = true;
      });
      this.gui.addColor(this, 'sphereColor').onChange(function (value) {
        _this.material.uniforms.sphereColor.value = new THREE.Color(value[0] / 255, value[1] / 255, value[2] / 255);
      });
    }
  }, {
    key: "update",
...
/***/ "./src/assets/js/_index/_glsl/marchingCubes.frag":
/*!*******************************************************!*\
  !*** ./src/assets/js/_index/_glsl/marchingCubes.frag ***!
  \*******************************************************/
/*! no static exports found */
...
/***/ "./src/assets/js/_index/_glsl/marchingCubes.vert":
/*!*******************************************************!*\
  !*** ./src/assets/js/_index/_glsl/marchingCubes.vert ***!
  \*******************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Main__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Main */ "./src/assets/js/_index/Main.js");
var ENV = __webpack_require__(/*! ../_env */ "./src/assets/js/_env.js");

var g = window[ENV.projectName] = window[ENV.projectName] || {};

window.addEventListener('DOMContentLoaded', function () {
  g.main = new _Main__WEBPACK_IMPORTED_MODULE_0__["default"]();
});
...
/***/ 0:
/*!********************************************!*\
  !*** multi ./src/assets/js/_index/init.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/kpalacio/Documentos/mapa/threejsMarchingCubesMetaball/src/assets/js/_index/init.js */"./src/assets/js/_index/init.js");
